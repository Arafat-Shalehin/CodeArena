                ...
                {!showAddFile ? (
                    ...
                    <div className="ml-1 flex items-center gap-1">
                        <input
                            ...
                            className="bg-bg-subtle border-border text-text-primary placeholder:text-text-muted focus:border-accent w-[100px] rounded border px-2 py-0.5 text-[11px] outline-none"
                            autoFocus
                        />
                        <button
