...
export default function ProblemsLayout() {
    ...
    const processedProblems = useMemo(() => {
        ...
        let result = initialProblems.filter(p => {
            ...
            const matchesTopic = selectedTopics.length === 0 || p.tags.some(tag => selectedTopics.includes(tag));
        ...
        return result;
    }, [initialProblems, searchQuery, selectedDifficulties, selectedStatuses, selectedTopics, sortBy]);
