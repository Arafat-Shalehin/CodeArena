            ...
            case "forgot-password":
                return (
                    <div className="text-center space-y-2">
                        ...
                        <p className="text-sm text-text-muted">We&apos;ll email you instructions to reset your password.</p>
                    </div>
                )
            case "magic-link":
                return (
                    <div className="text-center space-y-2">
                        ...
                        <p className="text-sm text-text-muted">We&apos;ll email you a secure link to sign in instantly.</p>
                    </div>
                )
            default:
                return (
        ...
        <div className="w-full max-w-md mx-auto space-y-6">
            {view !== "email" && (
                <button
                    ...
                    className="flex items-center text-sm text-text-muted hover:text-accent transition-colors"
                >
                ...
                <form className="space-y-6" onSubmit={loginForm.handleSubmit(onLoginSubmit)}>
                    <div className="space-y-2">
                        ...
                        {loginForm.formState.errors.email && (
                            <p className="text-xs text-error font-medium">{loginForm.formState.errors.email.message}</p>
                        )}
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        {loginForm.formState.errors.password && (
                            <p className="text-xs text-error font-medium">{loginForm.formState.errors.password.message}</p>
                        )}
                    </div>
            ...
            {view === "forgot-password" && (
                <form className="space-y-4" onSubmit={emailForm.handleSubmit(onForgotPasswordSubmit)}>
                    <div className="space-y-2">
                        ...
                        {emailForm.formState.errors.email && (
                            <p className="text-xs text-error font-medium">{emailForm.formState.errors.email.message}</p>
                        )}
                    </div>
            ...
            {view === "email" && (
                <>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <Button
                            variant="outline"
                            className="w-full bg-bg-surface border-border hover:bg-bg-subtle hover:text-accent col-span-2"
