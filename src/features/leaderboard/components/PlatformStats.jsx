 ...
 */
const SPARKLINES = [
  [0.55, 0.60, 0.58, 0.70, 0.66, 0.75, 0.80],   // Participants – growing
  [0.40, 0.55, 0.72, 0.60, 0.88, 0.76, 0.92],   // Submissions – volatile, peaking
  [0.80, 0.80, 0.80, 0.80, 0.80, 0.80, 0.80],   // Contests – flat / stable
  [0.72, 0.70, 0.69, 0.68, 0.67, 0.69, 0.68],   // Solve rate – slight decline
];
  ...
  return (
    ...
    >
      ...
      <div className="pl-5 pr-4 pt-4 pb-4">
        ...
        {/* Value */}
        <div
          className="text-2xl font-bold tracking-tight leading-none mb-3 font-mono"
