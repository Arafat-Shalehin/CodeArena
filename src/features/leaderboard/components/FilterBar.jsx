    ...
    return (
        <div className="flex flex-col md:flex-row gap-4 mb-8 items-center justify-between bg-bg-page p-4 rounded-2xl border-border shadow-sm">
            ...
            <div className="flex gap-2 w-full md:w-auto overflow-x-auto pb-2 md:pb-0 no-scrollbar">
                ...
                <select
                    className="pl-3 pr-8 py-2 bg-bg-page border border-border rounded-xl text-sm font-medium text-text-primary focus:outline-none focus:ring-2 focus:ring-accent/20 cursor-pointer appearance-none"
