 ...
 * @param {string} props.league - Current selected league filter value
 * @param {string} props.timeframe - Current selected timeframe filter value
 ...
 */
export function FilterBar({ searchQuery, league, timeframe, onSearchChange, onFilterChange }) {
    return (
        <div className="bg-bg-page border-border mb-8 flex flex-col items-center justify-between gap-4 rounded-2xl p-4 shadow-sm md:flex-row">
            ...
            <div className="flex w-full gap-3 overflow-x-auto pb-2 md:w-auto md:pb-0">
                <Select value={league} onValueChange={(value) => onFilterChange('league', value)}>
                    ...
                    <SelectContent>
                        ...
                        <SelectItem value="company">My Location</SelectItem>
                    </SelectContent>
                </Select>
