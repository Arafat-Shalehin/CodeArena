...
export default function Hero() {
    return (
        <section className="relative overflow-hidden pt-10 pb-18 lg:pb-2 hero-gradient">
            <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="relative z-10 space-y-8 text-center lg:text-left">
                    ...
                    <h1 className="text-6xl sm:text-7xl lg:text-8xl font-sans font-extrabold text-text-primary pt-3 leading-[0.9] tracking-[-0.04em]">
                        Master the <br className="lg:hidden" /> 
                        <span className="text-accent italic font-serif"> machine.</span>
                    </h1>

                    {/* Subheadline */}
                    <p className="text-lg md:text-xl text-text-secondary leading-relaxed max-w-xl mx-auto lg:mx-0">
                        The ultimate playground for competitive programmers. Solve curated problems, 
                        join high-stakes contests, and build your technical legacy.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-2 justify-center lg:justify-start">
                        ...
                        <Button variant="secondary" size="lg" className="w-full sm:w-auto h-12 px-8 text-base bg-background hover:bg-surface border border-border-base">
                            Explore contests
                        </Button>
                    </div>
            ...
            <div className="lg:hidden mt-12 pt-8 border-t border-border-base bg-surface/50 -mx-4 px-4">
                <div className="flex justify-center items-center gap-12 pb-8">
                    ...
                    <div className="h-10 w-px bg-border-base"></div>
                    <div className="text-center">
