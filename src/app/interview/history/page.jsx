            ...
            <div className="relative pt-4 pb-8">
                <div className="relative z-10 container mx-auto max-w-6xl px-6">
                    ...
                    >
                        <Link
                            href="/interview"
                            className="text-text-muted hover:text-accent inline-flex items-center gap-2 text-[10px] font-black tracking-[0.4em] uppercase transition-colors"
                        >
                    ...
                    <div className="flex flex-col items-center gap-4 text-center">
                        <header className="space-y-4">
                            <motion.h1
                                ...
                                className="text-text-primary text-6xl leading-[1.0] font-[1000] tracking-tighter md:text-7xl"
                            >
                                Session{' '}
                            ...
                            <motion.p
                                ...
                                className="text-text-secondary mx-auto mt-2 max-w-xl text-sm leading-relaxed font-medium opacity-70"
                            >
