        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                <div className="matte-surface border-border bg-bg-subtle/50 group hover:border-accent/30 relative overflow-hidden rounded-2xl border p-6 shadow-sm transition-all">
                    ...
                    <p className="text-text-muted relative z-10 mb-2 text-[10px] font-black tracking-widest uppercase opacity-70">
                        Total Accounts
                    </p>
                    <div className="relative z-10 flex items-center justify-between">
                        <h2 className="text-text-primary text-4xl leading-none font-black italic">
                            {users.length}
                        </h2>
                ...
                <div className="matte-surface border-border border-l-destructive bg-bg-subtle/50 group hover:border-accent/30 relative overflow-hidden rounded-2xl border border-l-4 p-6 shadow-sm transition-all">
                    ...
                    <div className="relative z-10 flex items-center justify-between">
                        <h2 className="text-error text-4xl leading-none font-black italic">
                            {adminCount}
                        </h2>
                ...
                <div className="matte-surface border-border border-l-primary bg-bg-subtle/50 group hover:border-accent/30 relative overflow-hidden rounded-2xl border border-l-4 p-6 shadow-sm transition-all">
                    ...
                    <div className="relative z-10 flex items-center justify-between">
                        <h2 className="text-accent text-4xl leading-none font-black italic">
                            {normalUserCount}
                        </h2>
                        <div className="bg-accent/10 text-accent flex size-10 items-center justify-center rounded-xl transition-transform group-hover:scale-110 group-hover:rotate-6">
                            <UserCheck size={24} />
                                ...
                                >
                                    <TableCell className="px-6 py-3">
                                        <div className="flex items-center gap-3">
                                            <div className="bg-accent/10 text-accent border-accent/20 flex size-9 shrink-0 items-center justify-center rounded-full border text-xs font-black transition-transform group-hover:scale-110">
                                                {user.name?.[0]?.toUpperCase() || 'U'}
                                            </div>
                                            <div className="min-w-0">
                                                <p className="text-text-primary group-hover:text-accent truncate text-sm leading-tight font-black uppercase italic transition-colors">
                                                    {user.name}
                                                </p>
                                                <p className="text-text-muted truncate text-[10px] font-bold">
                                                    {user.email}
                                                </p>
                                            </div>
                                        </div>
