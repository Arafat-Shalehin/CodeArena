...
class ErrorBoundary extends React.Component {
    ...
    render() {
        if (this.state.hasError) {
            ...
            return (
                <div className="flex flex-col items-center justify-center min-h-[400px] p-6 text-center space-y-4 rounded-lg border border-red-200 bg-red-50/50">
                    ...
                    <Button
                        ...
                        className="border-red-200 text-red-700 hover:bg-red-100 hover:text-red-900 hover:border-red-300"
                    >
                        Try Again
                    </Button>
                </div>
